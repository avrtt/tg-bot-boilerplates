...
from template1.infrastructure.config_loader import load_config
from template1.infrastructure.db.main import get_async_sessionmaker, get_engine

from template1.presentation.telegram import register_handlers, register_dialogs

from template1.presentation.ioc import IoC
